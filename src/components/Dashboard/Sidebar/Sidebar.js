  ...
  return (
    <nav id="sidebar" className={show ? "active" : ""}>
      <div className="sidebar-header">
        ...
        />{" "}
        <h2 className="d-inline-block">Sam Weds</h2>
      </div>
      {adminLoading ? (
        <SidebarLoader />
      ) : (
            ...
            <>
              <li>
                <Link
                  ...
                  className={panel === "orderList" ? "link-active" : ""}
                >
              ...
              <li>
                <Link
                  ...
                  className={panel === "addService" ? "link-active" : ""}
                >
              ...
              <li>
                <Link
                  ...
                  className={panel === "manageServices" ? "link-active" : ""}
                >
            ...
            <>
              ...
              <li>
                <Link
                  ...
                  className={panel === "bookingList" ? "link-active" : ""}
                >
              ...
              <li>
                <Link
                  to="/dashboard/review"
                  className={panel === "review" ? "link-active" : ""}
                >
